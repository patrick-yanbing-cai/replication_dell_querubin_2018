* ============================================================
* 17_plac_fs.do
* First stage placebo: tests if threshold predicts pre-period
* bombing BEFORE hamlet first approaches threshold
...
* Key distinction: keep PRE-period bombing (before closedate)
